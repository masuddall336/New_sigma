      ...
      <main>
        ...
        <section className='py-10 bg-[#fff]'>
          <div className='text-center'>
            ...
            <p className='text-[#404040] max-w-[1000px] mx-auto py-5'>Sigma Oil Industries Limited manufactures SOIL branded premium motorcycle engine oil. Use our SOIL products to supercharge your bike performance and explore the power of quality.</p>
