...
import banner from '../../../../public/soil/motorcycle-soil.jpg'
        ...
        <div className='h-[20vh] md:h-[60vh]'>
          ...
          <section id='header' className='relative h-[20vh]  md:h-[60vh] ' style={{
            ...
            <div className='absolute left-[10%] top-[30%] sm:top-[30%] md:top-[38%] lg:top-[35%] w-[90%] md:w-[70%]'>
              <h1 className=' py-[3px] pl-3 text-[1.5rem] sm:text-[2rem] md:text-[2.5rem] bg-no-repeat bg-[linear-gradient(93deg,rgba(0,39,118,.67)_0%,#fff0_50%)]  top-[36%] left-[10%]'>Soil</h1>
            </div>
          </section>
        </div>
        {/* path */}
        <section className='bg-[#fff] border-b-1  border-[#00000059]'>
          <div id='navigation_path' className='max-w-[1220px] mx-auto pl-10 sm:pl-0 bg-[#fff] text-[#000] text-sm  py-4 '>
            <ul className='flex gap-3 items-center'>
              ...
              <em className='italic'><span>/</span>Soil</em>
            </ul>
          </div>
        </section>
      </header>
      <main>
        ...
        <section className='py-10 bg-[#fff]'>
          <div className='text-center'>
            ...
            <h2 className='text-[#032e5b] text-[2rem] font-bold tracking-wider'>Premium Motorcycle Engine Oil - SOIL</h2>
            <p className='text-[#404040] max-w-[1000px] mx-auto py-5 px-5 sm:px-0'>Sigma Oil Industries Limited manufactures SOIL branded premium motorcycle engine oil. Use our SOIL products to supercharge your bike performance and explore the power of quality.</p>
            <NavLink className=' text-xs text-[#0056b3] hover:text-[#ff6319] uppercase font-[600] transition-all duration-300'>Ask for SOIL Brand Motorcycle Engine Oil Pricing ⤏</NavLink>
          </div>
        </section>
        ...
        <section className='bg-[#fff]  py-[2%]'>
          <div id='navigation_path' className='max-w-[1080px] px-5 md:px-0 mx-auto py-4'>
            <h2 className='text-[#032e5b] text-[2.3rem] text-center font-bold'>Why Choose SOIL Brand Motorcycle Engine Oil</h2>
