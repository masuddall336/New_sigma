...
const Threewheeler = () => {
    ...
    const banner = allDatas.three_wheeler[0].banner;
    const three_wheeler = allDatas.three_wheeler[1].three_wheeler_engine_oil;
    const three_wheeler_soil = allDatas.three_wheeler[2].SOIL_Branded_Engine_Oil_for_Three_Wheeler_Vehicles;
    console.log(three_wheeler_soil);
    ...
    return (
        <div>
            <header>
                <div className='h-[17vh] md:h-[60vh]'>
                    {/* header Part Banner */}
                    <section id='header' className='relative h-[17vh]  md:h-[60vh] ' style={{
                        ...
                        <div className='absolute left-[10%] top-[30%] sm:top-[30%] md:top-[38%] lg:top-[35%] w-[90%] md:w-[70%]'>
                            <h1 className=' py-[3px] pl-3 text-[1.5rem] sm:text-[2rem] md:text-[2.5rem] bg-no-repeat bg-[linear-gradient(93deg,rgba(0,39,118,.67)_0%,#fff0_50%)]  top-[36%] left-[10%]'>Three Wheeler</h1>
                        </div>
                    </section>
                </div>
                {/* path */}
                <section className='bg-[#fff] border-b-1  border-[#00000059]'>
                    <div id='navigation_path' className='max-w-[1060px] mx-auto pl-10 sm:pl-0 bg-[#fff] text-[#000] text-sm  py-4 '>
                        <ul className='flex gap-3 items-center'>
                            ...
                            <em className='italic'><span>/</span>Three Wheeler</em>
                        </ul>
                    </div>
                </section>
            </header>
            <main>
                ...
                <section className='py-10 bg-[#fff]'>
                    <div className='text-center'>
                        ...
                        <h2 className='text-[#032e5b] text-[2.2rem] font-bold tracking-wider '>Engine Oil for Three-Wheeler Vehicles in Bangladesh</h2>
                        <p className='text-[#404040] max-w-[1000px] mx-auto py-3 px-2 sm:px-0'>As an international standard engine oil manufacturer, Sigma Oil Industries Limited is serving the purpose of high performance in Three-Wheeler engines. We value the customer’s need for oil products that give their three wheelers engines a smoother performance.</p>
                        <p className='text-[#404040] max-w-[1000px] mx-auto pb-2 px-2 sm:px-0'>Our oils comply with industry standards and we follow the best practice to give a satisfactory experience to the clients. You can place your trust in our range of solutions for premium performance in your three-wheeler engine.</p>
                        <NavLink className=' text-xs text-[#0056b3] hover:text-[#ff6319] uppercase font-[600] transition-all duration-300'>Ask for Three Wheeler Engine Oil Pricing ⤏</NavLink>
                    </div>
                </section>
                {/* Our Oil for Three Wheeler Engines */}
                <section className='bg-[#ececec] py-[2%]'>
                    <div id='navigation_path' className='max-w-[1080px] px-5 md:px-0 mx-auto   py-4 flex flex-col items-center'>
                        <h2 className='text-[#032e5b] text-[2.3rem] text-center font-bold'>Our Oil for Three Wheeler Engines</h2>
                        <div className='border-[1px] border-[#032e5b] w-[10%]'></div>
                        <p className='text-[#404040] text-[1rem] py-3  text-center text-base/7'>To mobilize your three-wheeler engine that is made for highly paraffinic base stocks and fortified with selected additives to deliver satisfactory engine performance in any weather condition, Sigma Oil Industries Limited offering the top quality lubricating products for your three-wheeler vehicles.</p>
                        <div className='grid grid-cols-1 md:flex md:flex-wrap justify-items-center gap-5 '>
                            {
                ...
                <section className='bg-[#ececec] py-[2%]'>
                    <div id='navigation_path' className='max-w-[1080px] px-5 md:px-0 mx-auto   py-4 flex flex-col items-center'>
                        <h2 className='text-[#032e5b] text-[2.3rem] text-center font-bold'>SOIL Branded Engine Oil for Three-Wheeler Vehicles</h2>
                        <div className='border-[1px] border-[#032e5b] w-[10%]'></div>
                        <p className='text-[#404040] text-[1rem] py-3  text-center text-base/7'>If you are searching for premium quality three-wheeler engine oil, consider our SOIL Branded super grade lubricant made from highly refined base stocks with effective additives.</p>
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 '>
                            {
                                three_wheeler_soil.map(data => {
                                    return (
