...
import banner from '../../../../public/Naf Arab/motorcycle-naf-arab.jpg'
        ...
        <section className='bg-[#fff] border-b-1  border-[#00000059]'>
          <div id='navigation_path' className='max-w-[1220px] mx-auto pl-10 sm:pl-0 bg-[#fff] text-[#000] text-sm  py-4 '>
            <ul className='flex gap-3 items-center'>
              ...
              <em className='italic'><span>/</span>Naf Arab</em>
            </ul>
          </div>
        </section>
      </header>
      <main>
        ...
        <section className='py-10 bg-[#fff]'>
          <div className='text-center'>
            ...
            <em className='font-bold text-[#ad0000]'>Finest Oil</em>
            <h2 className='text-[#032e5b] text-[2rem] font-bold tracking-wider '>Premium Motorcycle Engine Oil - Naf Arab  </h2>
            <p className='text-[#404040] max-w-[1000px] mx-auto py-5 px-2 sm:px-0'>Sigma Oil Industries Limited offers Naf Arab branded premium motorcycle engine oil. Use our Naf Arab lubricant to supercharge your bike and explore the power of quality.</p>
            <NavLink className=' text-xs text-[#0056b3] hover:text-[#ff6319] uppercase font-[600] transition-all duration-300'>Ask for Naf Arab Engine Oil Pricing ⤏</NavLink>
          </div>
        </section>
        ...
        <section className='bg-[#fff]  py-[2%]'>
          <div id='navigation_path' className='max-w-[1080px] px-5 md:px-0 mx-auto py-4'>
            <h2 className='text-[#032e5b] text-[2.3rem] text-center font-bold'>Why Choose Naf Arab Engine Oil for Your Motorbike</h2>
